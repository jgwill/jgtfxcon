...
sys.path.insert(0, os.path.abspath('../jgtfxcon'))
from jgtfxcon import __version__
from jgtfxcon import jgtfxc,JGTPDS,jgtetl
...
intersphinx_mapping = {
    ...
    'jgtapy': ('https://jgtfxcon.jgwill.com', None)
}
