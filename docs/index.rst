.. jgtfxcon documentation master file, created by
   sphinx-quickstart on Mon Sep 23 02:03:02 2019.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to jgtfxcon's documentation!
================================

:Source Code: https://github.com/jgwill/jgtfxcon
:Issue Tracker: https://github.com/jgwill/jgtfxcon/issues
:PyPi: https://pypi.org/project/jgtfxcon/
...
::
   ...
   pip install jgtfxcon

Indicators
==========
.. autoclass:: jgtfxcon.JGTPDS
.. automodule:: __init__
